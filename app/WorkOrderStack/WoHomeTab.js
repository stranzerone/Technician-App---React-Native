  ...
  const dashboardOptions = [
    {
      ...
      color: "#0EA5E9",
      count: counts.OW,
      route:assetViewPermission?"MyWorkOrders":"WorkOrderHomeTab",
      active: true,
    },
    {
      key: "UW",
...
>
      ...
      <Pressable
        ...
        className="mt-8 mb-10 self-center bg-[#074B7C] px-6 py-3 rounded-full flex-row items-center shadow-md"
        style={{
