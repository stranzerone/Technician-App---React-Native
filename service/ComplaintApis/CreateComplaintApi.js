...
const payload ={
"complaint_type": data.data.complaint_category_id,
...
console.log(payload,"this is payload for complaint adding")
    ...
    try {
      const response = await axios.post(apiUrl,payload,{ params,headers});
